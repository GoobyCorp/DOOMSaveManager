...
"C:\Program Files\Microsoft Visual Studio\2022\Enterprise\MSBuild\Current\Bin\msbuild.exe" $Env:GITHUB_WORKSPACE\DOOMSaveManager.csproj /p:Configuration=Release /p:Platform=x86
:exit
popd
@echo on